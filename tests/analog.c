...
START_TEST(test_analog_si_prefix)
{
	struct {
		...
		{ 4635000000.            , -6,   4.635   , 3, "G", .0001    },
		{  463500000.            , -5, 463.5     , 1, "M", .01      },
		{   46350000.            , -4,  46.35    , 2, "M", .001     },
		{    4635000.            , -3,   4.635   , 3, "M", .0001    },
		{     463500.            , -2, 463.5     , 1, "k", .01      },
		{      46350.            , -1,  46.35    , 2, "k", .001     },
		{       4635.            ,  0,   4.635   , 3, "k", .0001    },
		{        463.5           ,  1, 463.5     , 1, "" , .01      },
		{        46.35           ,  2,  46.35    , 2, "" , .001     },
		{          4.635         ,  3,   4.635   , 3, "" , .0001    },
		{           .4635        ,  4, 463.5     , 1, "m", .01      },
		{           .04635       ,  5,  46.35    , 2, "m", .001     },
		{           .004635      ,  6,   4.635   , 3, "m", .0001    },
		{           .0004635     ,  7, 463.5     , 1, "µ", .01      },
		{           .00004635    ,  8,  46.35    , 2, "µ", .001     },
		{           .000004635   ,  9,   4.635   , 3, "µ", .0001    },
		{           .0000004635  , 10, 463.5     , 1, "n", .01      },
		{           .00000004635 , 11,  46.35    , 2, "n", .001     },
		{           .000000004635, 12,   4.635   , 3, "n", .0001    },

		/* Common values for power supplies */
		{        123.456         ,  3, 123.456  , 3, "" , .001      },
		{        123.4567        ,  4, 123.4567 , 4, "" , .0001     },

		/* Edge cases */
		{ 4635e12                , -12,   4635.      , 0, "T", .1       },
		{ .4635e-17              ,  21,       .004635, 6, "f", .0000001 },
