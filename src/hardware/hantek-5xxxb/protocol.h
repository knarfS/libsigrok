...
static const uint32_t sample_count[][2][2][4] = {
	...
	{{{ 3840, 38400, 384000, 384000 }, { 3200, 32000, 320000, 320000 }}, {{ 3840, 38400, 384000, 0 }, { 3200, 32000, 320000, 0 }}}, /* 200 us */
...
struct __attribute__((packed)) hantek_5xxxb_sys_data {
	...
	/*
	 * This is not used in the Voltcraft 1062D/3062C scopes, but in the handheld
	 * scopes Hantek DSO1202B/BV, DSO1102B/BV and DSO1062B/BV, but I can't
	 * verify this...
	 */
	/*
	uint8_t dmmctl_type;
