...
static struct sr_key_info sr_key_info_config[] = {
	...
	{SR_CONF_OVER_TEMPERATURE_PROTECTION_ENABLED, SR_T_BOOL, "otp_enabled",
		"Over-temperature protection enabled", NULL},
	...
	{SR_CONF_UNDER_VOLTAGE_CONDITION_ENABLED, SR_T_BOOL, "uvc_enabled",
		"Under-voltage condition enabled", NULL},
